...
public class FinalizedDayView extends javax.swing.JDialog {
    ...
    /**
     * Creates new form FinalizedDayView
     */
    ...
    private void initContent() {
        ...
        Map<String, Integer> response2;
        GregorianCalendar calendar = new GregorianCalendar();
        SimpleDateFormat dateFormat = new SimpleDateFormat("dd-MMMM-yyyy"); 
        AnimalController animalController = new AnimalController();
        response = animalController.processMoneyClosing();
        response2 = animalController.processAnimalClosing();
        Object[] rowDataMoney = {dateFormat.format(calendar.getTime()).toString(), response.get("Cow"), response.get("Horse"), response.get("Rooster"), response.get("Chicken"), response.get("Total")};
        Object[] rowDataAnimals = {dateFormat.format(calendar.getTime()).toString(), response2.get("Cow"), response2.get("Horse"), response2.get("Rooster"), response2.get("Chicken"), response2.get("Total")};
        DefaultTableModel moneyTable;
        moneyTable = (DefaultTableModel) this.tblMoney.getModel();
        moneyTable.addRow(rowDataMoney);
        DefaultTableModel animalsTable;
        animalsTable = (DefaultTableModel) this.tblAnimals.getModel();
        animalsTable.addRow(rowDataAnimals);
    }
}
